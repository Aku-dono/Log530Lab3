...
public class FinanceJApplication extends Application{
    ...
    public void onCreate() {
        ...
        try{
            ...
            entry1.setTdate(Date.valueOf("2013-11-11"));
            entry1.setPayee("John");
            ...
            entry2.setTdate(Date.valueOf("2013-11-11"));
            entry2.setPayee("Pianoilin");
            ...
            entry3.setTdate(Date.valueOf("2013-11-11"));
            entry3.setPayee("George");
